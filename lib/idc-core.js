...
//const _fileRegister = path.join(dataDir, fnRegister);
...
module.exports = class idcCore {
	...
	*/
	...
	readRegisterset() {
		try {
			const jsonData = fs.readFileSync(fnRegister, { encoding: 'utf8', flag: 'r' });
	...
	readCoilset() {
		...
		try {
			const jsonData = fs.readFileSync(fnCoils, { encoding: 'utf8', flag: 'r' });
